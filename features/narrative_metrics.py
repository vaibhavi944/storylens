...
from features.emotion import analyze_emotion
from features.hook_strength import calculate_hook_strength
from features.repetition import calculate_repetition_score
from features.scene_classifier import classify_scene
